<table>
    ...
    <tr>
        ...
        {{-- <th style="width: 350px; text-align: center; font-weight: bold; background-color: #00599D; border: 1px solid #000000; color: white">DASHBOARD ACTIVITY</th> --}}
    ...
    <tbody>
        @foreach ($tasks as $task)
            <tr>
                ...
                <td style="vertical-align: top; text-align:center; border: 1px solid #000000;">@isset($task->actual_handling_time) {{ $task->actual_handling_time }} @else - @endisset</td>
                <td style="vertical-align: top; text-align:center; border: 1px solid #000000;">@isset($task->volume){{ $task->volume }} @else - @endisset</td>
                <td style="vertical-align: top; word-wrap: break-word; white-space: nowrap; border: 1px solid #000000;">@isset($task->remarks){{ $task->remarks }} @else - @endisset</td>
                <td style="vertical-align: top; text-align:center; border: 1px solid #000000;">
