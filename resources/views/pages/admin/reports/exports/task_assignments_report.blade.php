<table>
    ...
    <tr>
        ...
        <th style="width: 120px; text-align: center; font-weight: bold; background-color: #00599D; border: 1px solid #000000; color: white">APPLICABLE MONTH</th>
        ...
        <th style="width: 350px; text-align: center; font-weight: bold; background-color: #00599D; border: 1px solid #000000; color: white">CLIENT FUNCTION</th>
        <th style="width: 350px; text-align: center; font-weight: bold; background-color: #00599D; border: 1px solid #000000; color: white">ECLERX FUNCTION</th>
    ...
    <tbody>
        @foreach ($tasks as $task)
            <tr>
                ...
                <td style="vertical-align: top; word-wrap: break-word; white-space: nowrap; border: 1px solid #000000;">{{ $task->theclientactivity->function }}</td>
