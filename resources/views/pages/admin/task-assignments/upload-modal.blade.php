    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="uploadTaskAssignmentsForm" action="{{ route('client-activity-import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary waves-effect waves-light" onclick="store('uploadTaskAssignmentsForm')"><i class="fa fa-save"></i> Save</button>
