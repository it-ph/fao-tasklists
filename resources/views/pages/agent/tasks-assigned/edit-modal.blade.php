                        ...
                        <div class="col-md-12">
                            <div class="mb-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="hidden" name="agent_id" id="agent_id" value="{{ auth()->user()->id }}">
                        ...
                        <div class="col-md-6">
                            <div class="mb-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="quality" id="quality_edit" style="width:100%;" disabled>
