                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <div class="dropdown-header d-flex flex-column align-items-center">
                        ...
                        <div class="text-center">
                            <h5 class="name font-weight-bold mb-0">@isset(Auth::user()->employeeprofile) {{ Auth::user()->employeeprofile->fullname }} {{ Auth::user()->employeeprofile->last_name }} @endisset</h5>
