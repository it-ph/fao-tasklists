                    ...
                    <div class="row">
                        <div class="col-9">
                            <div class="text-white p-3">
                                ...
                                <p>FAO Tasklists Dashboard</p>
                            </div>
                        </div>
                        <div class="col-3 align-self-end pt-2 pb-2">
                            <img src="{{ URL::asset('/assets/images/dashboard.png') }}" alt="" class="img-fluid" width="75%">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="avatar-md profile-user-wid mb-4">
                                <img src="{{ asset('assets/images/user2-160x1601.png') }}" class="img-thumbnail rounded-circle">
                            </div>
                            <h5 class="font-size-15 text-truncate">@isset(Auth::user()->employeeprofile) {{ Auth::user()->employeeprofile->fullname }} {{ Auth::user()->employeeprofile->last_name }} @endisset</h5>
